...
.. grid::
    ...
    .. grid-item-card:: 增加人物和机体（真实系路线）
      :columns: auto
      
      * 分歧参考 :ref:`隐藏要素 <srw4_missable>`
      * 走超级系路线时也启用
      * 7E110687 增加哈曼卡恩
      * 7e118710 哈曼编队
      * 7E1104B4 增加托特
    ...
    .. grid-item-card:: 额外增加人物和机体（超级系路线）
      :columns: auto
...
.. grid::
    ...
    .. grid-item-card:: Fatima on Everyone
      :columns: auto
    ...
    .. grid-item-card:: 系统设置
      ...
      | 311046F6 00000060 全开
      | 311046F6 00000000 全关
    ...
    .. grid-item-card:: 地形适应
      ...
      | 3004642B 0001 GP-03デンドロビウム 移动类型空陆
      | 3004642C 0044 GP-03デンドロビウム 空A海A
      | 3004642D 0044 GP-03デンドロビウム 宇A陆A
      | 30046276 0043 ヒュッケバイン 空A海A
      | 30046275 0001 ヒュッケバイン移动类型空陆
      | 300462AE 0044 グルンガスト空A海A
      | 300462AF 0044 グルンガスト宇A陆A
      | 3004F90B 00FE 必殺烈風正拳突き 空A陆A海A宇B
      | 30050CAB 00FE 必殺烈風正拳突き 空A陆A海A宇B
    ...
    .. grid-item-card:: 增加机体 （\ :ref:`隐藏要素 <srw4_missable>`\ 路线A/C）
      ...
      | 8010407D 00001EE9 ゲイオス＝グルード
      | 801040B9 00001EEA ライグ＝ゲイオス
      | 801040F5 00001f0c ニセサイバスター
      | 80104131 00001EEB バラン＝シュナイル
      | 8010416D 00001E50 ブラッドテンプル
      | 801041A9 00001E85 ゲーマルク
      | 801041E5 00001EE6 グラシドゥ＝リュ
      | 80104221 00001E7A キュベレイ

    .. grid-item-card:: 增加人物  （\ :ref:`隐藏要素 <srw4_missable>`\ 路线A/C）
      :columns: auto

      | 30103F47 00000098 ナナイ＝ミゲル
      | 31103F48 00000004
      | 30103F83 00000092 グレミー＝トト
      | 31103F84 00000004
      | 30103FBF 00000044 ベルナルド＝モンシア
      | 31103FC0 00000004
      | 30103FFB 00000036 モンド＝アガケ
      | 31103FFC 00000004
      | 30104037 00000099 レズン＝シュナイダー
      | 31104038 00000004
      | 30104073 000000D4 ミラウー＝キャオ
      | 31104074 00000004
      | 301040AF 00000037 エル＝ビアンノ
      | 311040B0 00000004
      | 301040EB 00000035 ビーチャ＝オレーグ
      | 311040EC 00000004
      | 30104127 000000A0 あしゅら男爵
      | 31104128 00000004
      | 30104163 000000D8 アマンダラ＝カマンダラ
      | 31104164 00000004
      | 3010419F 00000024 マチルダ＝アジャン
      | 311041A0 00000004
      | 301041DB 0000002F ヘンケン＝ベッケナー
      | 311041DC 00000004
      | 30104217 00000087 ハマーン＝カーン 
      | 31104218 00000004
    ...
    .. grid-item-card:: 额外增加人物  （:ref:`隐藏要素 <srw4_missable>` 路线B）
      ...
      | 30103DA3 00B4 トッド＝ギネス
      | 31103DA4 0004
      | 30103DDF 00B6 黒騎士
      | 31103DE0 0004
      | 30103E1B 00bc ゼット＝ライト
      | 31103E1C 0004
      | 30103E57 00BE ジェリル＝クチビ 
      | 31103E58 0004
      | 30103E93 00B5 バーン＝バニングス
      | 31103E94 0004
      | 30103ECF 00D9 オルドナ＝ポセイダル
      | 31103ED0 0004
    ...
    .. grid-item-card:: 远地点控制发动机
      ...
      | 9010722C 32141703 移动力+3 运动性+23 限界+20 装甲+500     
    ...
    .. grid-item-card:: FATIMA
      ...
      | 90107230 32282403 移动力+4 运动性+36 限界+40 装甲+500     
      | 901072b0 000403e8 HP +1000 光线护壁

    .. grid-item-card:: ALICE
      :columns: auto

      | 90107234 32281E02 移动力+2 运动性+30 限界+40 装甲+500     
      | 901072b4 000403e8 HP +1000 光线护壁      

    .. grid-item-card:: 精神力框架
      :columns: auto

      | 90107238 322D1C02 移动力+2 运动性+28 限界+45 装甲+500     
      | 901072b8 000403e8 HP +1000 光线护壁     

    .. grid-item-card:: 生物传感器
      :columns: auto

      | 9010723C 32231A02 移动力+2 运动性+26 限界+35 装甲+500     
      | 901072bC 000403e8 HP +1000 光线护壁

    .. grid-item-card:: 磁铁镀膜
      :columns: auto

      | 90107240 321E1702 移动力+2 运动性+23 限界+30 装甲+500     
      | 901072C0 000403e8 HP +1000 光线护壁

    .. grid-item-card:: I立场发生机
      :columns: auto

      | 90107244 32141202 移动力+2 运动性+18 限界+20 装甲+500     
      | 901072C4 000403e8 HP +1000 光线护壁      
    ...
    .. grid-item-card:: 护壁发生机
      ...
      | 90107250 96281202 移动力+2 运动性+18 限界+40 装甲+1500     
      | 901072D0 00040fa0 HP +4000 光线护壁  

    .. grid-item-card:: 反光束涂层
      :columns: auto

      | 90107254 96281202 移动力+2 运动性+18 限界+40 装甲+1500     
      | 901072D4 00040fa0 HP +4000 光线护壁  

    .. grid-item-card:: 修理工具包
      :columns: auto

      | 90107258 96281202 移动力+2 运动性+18 限界+40 装甲+1500     
      | 901072D8 00040fa0 HP +4000 光线护壁  

    .. grid-item-card:: 螺旋桨油箱
      :columns: auto

      | 9010725C 96281202 移动力+2 运动性+18 限界+40 装甲+1500     
      | 901072DC 00040fa0 HP +4000 光线护壁  
    ...
    .. grid-item-card:: 推进剂荚舱S
      ...
      | 90107260 96281202 移动力+2 运动性+18 限界+40 装甲+1500     
      | 901072E0 00040fa0 HP +4000 光线护壁  