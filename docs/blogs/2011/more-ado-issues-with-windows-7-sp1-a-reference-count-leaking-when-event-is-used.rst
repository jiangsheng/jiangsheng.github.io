...
.. container:: zemanta-img
   ...
   Wikipedia"]\ |Windows Update|\ [/caption]
...
execute call  leaks three handles and about 20K of memory. A fix is
...
`kb983246 was
delivered <http://jiangshengvc.wordpress.com/2011/02/24/breaking-change-in-ado-update-kb983246-included-in-windows-7-service-pack-1/>`__.
...
request a hotfix, once that is available. By the way, if you are still
...
.. |Windows Update| image:: http://upload.wikimedia.org/wikipedia/en/thumb/b/b0/Windows_Update.png/300px-Windows_Update.png
   :width: 300px
   :height: 224px
   :target: http://en.wikipedia.org/wiki/File:Windows_Update.png
