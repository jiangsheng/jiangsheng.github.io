...
ask for the user agent? Well the webbrowser control is an
...
browser window is created. The list of ambient properties can be found
in the `walkall
...
have global effect. Another way to change the user agent is to go
