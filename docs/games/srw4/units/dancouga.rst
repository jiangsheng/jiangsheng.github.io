...
在众多合体机器人中，兽战机队的分离机体属于最强的，要速通的话可以派出断空我然后分离出来战斗，可以节省三个出场名额。
...
鹰战机的兽形态，和断空我共享机体属性改造段数所以如果不打算用コンバトラV的话，入手之后可以开始改造。第四次因为断空我不能飞，所以如果不是要看剧情的话，通常都是保留コンバトラーV的。第四次S没有和コンバトラーV二选一的问题，断空我能飞了，武器也变强了，但是忍的加速换了魂，移动力又成了问题……
...
变形成突击形态需要120气力。和イーグルファイターN比起来运动性、装甲、限界、移动力都有上升，并且增加了一个突击武器。
