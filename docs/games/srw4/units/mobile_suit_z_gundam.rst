...
.. _srw4_units_mobile_suit_z_gundam_commentEnd:

--------
我军机体
--------
.. _srw4_units_mobile_suit_z_gundam_own_commentBegin:
...
攻击能力是摆好看的，机体太脆，而且很多敌人有光线护盾，没有用手加减把敌人HP降到10还是不要上去打了。

本作可变性单位大多在人形状态下性能优于飞行状态，例如变形后无法进行盾牌防御或者切防御。因此建议仅在移动时变形，而在攻击时恢复人型态以获得地形加成。例外大概是S高达变形后地形适应更佳，存在变形才能发挥优势的情况。

本作修理能力和机师等级有关，机动战士系的机师等级很容易用地图武器练满，所以超级系的修理机都是摆好看的……

因为限界上限299，终盘生存能力堪忧，建议改造HP和装甲。
...
因为培养机师所需，缺乏资金时可改造巴尔干炮，资金宽裕时可改造光束步枪用于反击，仅凭地形适应A即可打出和空B的灵格斯相当的伤害。本作陆A机师远多于陆A机体，本机改造价值远高于灵格斯，直到在PS版中灵格斯也改成了空A，本机才黯然失色。在S高达、ZZ高达等强力机体获取之前，将和灵格斯竞争Z高达之后的次级主力地位。
...
代号FXA-05D。G防卫号是为强化高达Mk-II而开发的支援战斗机。与\ :ref:`ガンダム Mk-II <srw4_unit_gundam_mk_ii>`\ (高达 Mk-II)合体时，可形成强化高达 Mk-II装甲、机动性与火力的\ :ref:`スーパーガンダム <srw4_unit_super_gundam>`\ (超级高达)形态。需要两机同时出击在战场上完成合体。因为超级高达的战斗力是看高达 Mk-II的机师，所以本机可以用来培养较弱的机师。

理论上也可搭载于\ :ref:`ネモ <srw4_unit_nemo>`\ (尼莫)或\ :ref:`GM III <srw4_unit_gm_iii>`\  (吉姆Ⅲ)等机体，但是本作未实现。
...
超级高达，正式名称是高达Mk-II防卫号。需要\ :ref:`ガンダム Mk-II <srw4_unit_gundam_mk_ii>`\ (高达 Mk-II)和\ :ref:`Gディフェンサー <srw4_unit_g_defender>`\ (G-防卫号)分别出击，在战场上合体才能出现。

本作虽然开放了副驾驶员的精神，但是获得经验的公式方面，不如上作的按主驾驶员计算，而是分别独立计算，所以不建议继续让低等级驾驶员驾驶高达 Mk-II。尽管如此，如果使用幸运击落高等级敌人，仍能有效加速基斯这样的战斗能力差且有幸运精神的机师升级。问题是本作中地图武器升级更快，甚至可以升到远远超过敌方等级的程度，所以在后期用处不大。在初期升级的时候注意要压级，不要超过敌人等级-8，这样在\ :ref:`百式 <srw4_unit_hyaku_shiki>`\ 入手的时候可以立刻用地图炮刷级，让经验值最大化。

陆地适应是A，实际性能比很多账面数据更高的机体要好，攻防比\ :ref:`ガンダム Mk-II <srw4_unit_gundam_mk_ii>`\  (高达 Mk-II)有所提升。机体能力改造继承ガンダム Mk-II，武器改造继承两个合体的机体的改造段数。

比起ガンダム Mk-II来，超级高达的HP、移动力、地形适应、运动性、装甲、限界都有小幅提升——不过还是很脆，可以加装高性能雷达避免被反击。后期面对敌人时逐渐力不从心，不过这时候应该多用地图炮升级而不是再依赖超级高达的两份经验值。

第四次S中对多数MS的攻击力和地形适应进行了改善，但是超级高达性能并未一起提高，以至于泯然众人矣。虽然双份精神和经验值仍旧有吸引力，但是到能用地图炮刷机的游戏中期，似乎没有必要再挤占出击名额。
...
游戏初版存在击落友军也可获得资金和经验的漏洞，所以在战斗结束之前将友军（组合机器人可以分离）布置在其前面轰上一炮升级，反正维修费一般可以赚回来，这是免费的经验值。一些特定机体的维修费比奖金贵，需要注意。


\ :doc:`../walkthrough/31_storm_of_kilimanjaro`\ 这一话作为NPC出场。
...
代码MSZ-006。奥古和阿纳海姆联合研发的可变性机动战士。地形适应空陆都是A，而且变形之后移动力也比较强，是可以用到最后的机体。大招消耗少，攻击力也不错，改造一下就可以打穿敌人的奥拉光线护盾，威力高过浮游炮。

游戏大多数时间是陆战，这也意味着它比νガンダム（陆B）都要强，在EN回复地形上基本上是本作最强的MS，排除犯规的ZZ不算的话。在机动战士系里实用性只有ビギナ・ギナ可以相比，不过ビギナ・ギナ入手太晚了。

第四次S里武器威力有所提高，不过浮游炮的威力提高之后，相对弱了一些。

尽管可以变形，但是我军空A的机师比较少，而且要利用地形补正的话就不能在空中，所以除了强制以空中形态出击的地图和赶路之外，通常都不会以ウェイブライダー形态作战。
...
除了地图武器没有什么可看的，但是有这个就够刷级了。改造优先地图炮和EN，但是在资金有限时，显然ZZ更为优先。除了地图炮之外乏善可陈，连地面适应都只有B（PS版升级到A)，在为数不多的宇宙地图才能发挥全部实力。另外相对于其他地图武器来说，本机的地图武器无需气力即可发射也是个优点。

.. _srw4_unit_hyaku_shiki_commentEnd:

--------
敌军机体
--------
.. _srw4_units_mobile_suit_z_gundam_enemy_commentBegin:
...
代号RMS-154。和\ :ref:`マラサイ <srw4_unit_marasai>`\ (玛拉塞)一样差的机体。作为副官来说，クランプ的待遇真差……后来老兵の挽歌里乘坐的R・ジャジャ也不怎么样。
...
代号RX-139。一般的机动战士系机体。虽然名字叫做海蛇，但是对海适应是C，武器基本都不能对海中的敌人使用……
...
代号RX-139。武器和运动性和人形态比起来差了很多，跑路用的形态电脑还用来交战……
...
代号MA-05。虽然理论上是大型单位，但在本作中却变成了中等大小。
...
代号MAN-03。HP比较高。精神感应巨型粒子炮居然没有技能要求。
...
代号AMX-107。逃往阿克西斯的吉翁残党所开发的Newtype专用机动战士（MS）。原本作为\ :ref:`エルメス <srw4_unit_elmeth>`\ (艾尔梅斯)的二号开发，但其精神感应系统运行需极高新人类能力，导致除\ :ref:`ハマーン・カーン <srw4_pilot_haman_karn>`\ (哈曼·卡恩) 外无人能驾驭，正因如此才成为"新吉翁的象征。

本作中只有量产型\ :ref:`キュベレイ Mk-II <srw4_unit_qubeley_mk_ii>`\  (卡碧尼 Mk-II)能够入手。卡碧尼本身仍然是Boss机，好在不用交战。在真实系限定的路线\ :ref:`第四十一话Ｂ ハマーンの黒い影 <srw4_walkthrough_41b_haman_s_black_shadow>`\ 只需要先用\ :ref:`ジュドー・アーシタ <srw4_pilot_judau_ashta>`\ (捷多·亚西塔) 说得，就可以在人少的时候让哈曼撤退。由于击落她仅能获得3000资金，不如让其速速离场更为明智。

.. _srw4_unit_qubeley_commentEnd:

----------
未登场机体
----------
.. _srw4_units_mobile_suit_z_gundam_dead_data_commentBegin:
...
.. _srw4_unit_audhumla_commentEnd:
