...
作为超级系来说居然有射程为8的武器，残弹也不算少，使用频率比ゴッドバード和ゴッドボイス还高，可以改造一下。ゴッドボイス虽然攻击力高，但是使用超过10次的话，最后一话不能出战，所以平时还是以ゴッドバード为主力武器，除非是为了对付ブラッドテンプル之类的敌人王牌。由于加入后仅有9次出战，建议每个关卡最多使用一次，确保本机能用到最终战。如果用地图武器刷级导致不缺攻击队员，则可以自由使用。当然，因为其130的EN消耗，不补给很难用第二次。

因为是单座机器人，缺乏幸运和加速，以及大招不能随便用的原因，大概只能在急需活力的后期A队活跃。也因此最强的两个武器都需要改造。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. grid:: 
            ...
            .. grid-item:: .. image:: ../pilots/images/srw4_pilot_A3.png
                :columns: auto
...
仅在超级系路线中出现。HP和装甲都超过\ :ref:`巨大シャーキン <srw4_unit_giant_sharkin>`\ (巨大夏金)，但是命中率很低。第四次中火炎不知为何变成了格斗武器，第四次S中修正。
...
本作中修正了上一次超级机器人大战中不能飞的问题。但是不论哪方面能力都并不算强。
...
比较没有存在感，只出战一次，人物复活还是超级系限定以至于在真实系路线显得突兀。有五段改造，攻击力不可小视。如果在增援之前就通关，则不会注册到机器人大图鉴。
...
莱汀的仿制品。但是即使在原作中，相似程度也很低。射程有7大概是唯一优点。
