...
.. grid:: 
    ...
    .. grid-item::
        ...
        | 地形参照
        | :ref:`竜崎一矢 <srw4_pilots_kazuya_ryuzaki>`
...
戴莫斯远程的武器攻击低残弹少。近身的武器虽然很多，但是重复性太高，除了大招之外，就连需要涨气力之后才能用的武器攻击力也才一千出头，基本都没有什么改造价值，除了暴击率+30的双竜剣。作为单座机器人，缺乏幸运和加速，大招也不能在宇宙中使用，后期出场价值较低。必杀技消耗70EN，虽然不算高，但是相比雷登和泰坦3来说仍为耗油大户，更不要说跟盖塔相比。另外，因为单座的原因，缺乏加速，机动性欠佳，难以从射程外加速发动猛烈攻势。唯一可取之处，大概是因为加入较早，改造段数较高而已。
...
本作没有强制入海的地图，在有空B的场合，无论海C还是海D，海洋都是不会主动进入的地形。地形适应的设定更改可以说是基本没有实际意义……
...
.. grid:: 
    ...
    .. grid-item::
        ...
        | 地形参照
        | :ref:`桜野マリ <srw4_pilots_mari_sakurano>`
...
.. grid:: 
    ...
    .. grid-item::
        ...
        | 地形参照
        | :ref:`リヒテル提督 <srw4_pilots_richter>`
