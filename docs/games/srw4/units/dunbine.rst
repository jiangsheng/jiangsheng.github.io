...
波臣作为玛贝露、、尼、基恩的机体登场，但在获得\ :ref:`ビルバイン <srw4_unit_bilvine>`\ （比尔拜因）时会强制废弃1架，若满足利姆鲁加入条件则需用莱尼克交换再强制废弃1架。若选择加拉利亚加入路线，则仅能获得玛贝露的1架机体，因此可在获取比尔拜因前自行废弃变现；但需注意若选择加拉利亚未加入路线，自行废弃会导致部分飞行员无机可用。
...
运动性略逊于塞拜因，但HP较高且装甲更厚，更有HP恢复（小），在后期回避到达限界255时生存能力属于我军最强。然而于\ :ref:`ビルバイン <srw4_unit_bilvine>`\ （比尔拜因）相比，缺乏远程能力，移动力亦处于劣势。强化部件方面，相较机动性提升系，装甲系反而更契合其特性，搭载拥有铁壁而远攻乏力的的加拉利亚亦是良策，不依赖回避也可作为肉盾使用，为我军铁壁防御机体的终极形态。但需注意HP过高以至于在有其他更弱目标时会被敌人无视，不适应团队作战。
