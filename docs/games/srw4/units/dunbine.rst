...
本作起奥拉战士(AB)需圣战士技能才能使用奥拉斩，但作为补偿被设定为零消耗武器，虽入手初期略显冷门，经改造后却能展现违规级强度。第四次S中奥拉斩改为EN消耗武器。
...
因为具有高回避和分身能力，奥拉系机体是我军的王牌，在游戏后期之前，作为主力坦克活跃于战场。

虽然本系机体宇宙适应较差，但是真正宇宙作战只有两次，问题不大。后期的问题主要是限界255的上限限制，虽然以S的大小以及分身能力可以应付，但在敌人数量过多时仍然生存能力堪忧，这个角色才逐渐让位于超级系的机器人。但是高HP的单位通常运动性和命中率低下，以至于在敌方回合防御效果更佳，不像本系机体一样可以用反击削弱敌人，所以这是一个降级。

注意后期会统一分去B队，以至于A队陷入苦战，所以应预先培养超级系肉盾以作替补。

奥拉斩改造过于昂贵，一般只能改满两到三台机器的奥拉斩，所以投入资金至过多奥拉机器属于浪费。
...
由于\ :ref:`ビルバイン <srw4_unit_bilvine>`\ （比尔拜因）正在维修，翔便驾驶了这架丹拜因出场。虽然终于得以作为主角机登场，但机体性能早已跟不上翔的能力，更糟的是无需等待比尔拜因，仅过几话就能获得隐藏机体雪拜因或兹瓦乌斯，而且获取时还必须使用本机的灵能转换器导致其报废，可谓待遇堪忧。虽具备可用性能，但因前述因素往往很快便被弃用。若坚持使用到后期可改造，否则装备芯片直到换机就好。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. grid:: 
            ...
            .. grid-item:: \ :ref:`技能 <srw4_unit_specialty>`\ : 分身、剣装備、オーラバリア、变形(\ :ref:`ウイングキャリバー <srw4_unit_wing_caliber>`\ (翼比尔拜因))。
                :columns: auto
...
由于奥拉转换器出现故障正在维修，该机体一度缺席战场。期间被A国夺取，并在地面路线第24话《提坦斯的崛起》中作为艾伦的驾驶机以敌方身份登场。不过由于其HP和装甲与在我方时相同且未经改造，实力并不突出，建议配合精神指令轻松击落。紧接着在次话《超级杰利尔》中，翔于增援时登机，终于正式加入我方阵营。这也意味着翔被迫从改造好的雪拜因或兹瓦乌斯转驾未经改装的\ :ref:`ビルバイン <srw4_unit_bilvine>`\ （比尔拜因），战斗力有所下降。更糟的是，此时若未大幅提升等级，则玛贝尔尚未习得圣战士技能。不过这比后期被迫转乘GP-03S沦为战力废柴的科还是要强得多……

HP值较前作大幅降低，未经改造时稍显吃力。此外前述的塞巴因或兹瓦乌斯获取更早，除射程外几乎全面超越比尔巴因的性能，因此若未计划培养除翔之外的奥拉机师，比尔巴因常被闲置仓库的情况并不少见。
...
因为远程武器强，可以让玛贝露・弗洛森驾驶，充分发挥其远攻击优势。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. grid:: 
            ...
            .. grid-item:: \ :ref:`技能 <srw4_unit_specialty>`\ : 分身、オーラバリア、变形(\ :ref:`ビルバイン <srw4_unit_bilvine>`\ (比尔拜因))。
                :columns: auto
...
巴斯托作为隐藏要素和嘉拉莉亚・纽姆希一起加入。虽然性能较低，但若想将包括嘉拉莉亚在内的三位圣战士全部作为主力使用，就需要对这台机体进行改造。虽说性能较低，但仅是和那些强得犯规的机体相比，于同期加入的波臣和丹拜因仍属优秀，所以此时反而更适合让能使用集中技能的翔或玛贝露・弗洛森驾驶。配合圣战士们的能力，作为全程作战机体完全不成问题。缺点在于宇宙适应为C，不过仅有两话需要在宇宙作战。亦大量作为敌方机体登场。
...
波臣作为玛贝露・弗洛森、、尼、基恩的机体登场，但在获得\ :ref:`ビルバイン <srw4_unit_bilvine>`\ （比尔拜因）时会强制废弃1架，若满足利姆鲁加入条件则需用莱尼克交换再强制废弃1架。若选择嘉拉莉亚・纽姆希加入路线，则仅能获得玛贝露的1架机体，因此可在获取比尔拜因前自行废弃变现；但需注意若选择嘉拉莉亚未加入路线，自行废弃会导致部分飞行员无机可用。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. grid:: 
            ...
            .. grid-item:: \ :ref:`技能 <srw4_unit_specialty>`\ : 分身、剣装備、HP恢復(小)、オーラバリア。
                :columns: auto
...
在16话中，雪拜因和シルキー同时加入。和ズワウス、ダンバイン三选一。只能进行近战，但是威力强大。

虽装甲较兹瓦乌斯稍薄，但在奥拉战士更需要的能力——运动性与移动力方面占据优势。然而本作限界上限仅255，后期生存能力略逊于兹瓦乌斯。不过两机均具备战斗至终局的能力，单纯根据个人喜好选择亦无不可。

相较于\ :ref:`ビルバイン <srw4_unit_bilvine>`\ （比尔拜因），这台机体更极致地体现了奥拉巴托拉核心价值——"高机动性"。虽无射击武器，但本作敌方单位的AI设定是命中率低下时会主动切换至巴尔干炮这类命中修正高的近战武器。因此只要让回避率高的翔驾驶员坐镇前线，敌方单位就会主动靠近。这使得射程的缺陷几乎不构成实质影响。不过远距离的劣势并非完全丧失，如果敌人完全缺乏近战能力，若不想陷入进退维谷的窘境，建议启用比尔拜因。

若让翔驾驶本机，其尚可的射击攻击力将沦为废属性，因此相较之下，格斗能力与翔相当而射击偏低的嘉拉莉亚・纽姆希反而更契合。
...
实际上是OVA中敌方最终Boss。本作直接拿来当友军单位，可谓闻所未闻。

兹瓦乌斯和シルキー同时加入。和雪拜因、丹拜因三选一。出于某种问题，オーラソード和クラフトドリル的工艺钻共享改造段数。

运动性略逊于雪拜因，但HP较高且装甲更厚，更有HP恢复（小），在后期回避到达限界255时生存能力属于我军最强。然而于\ :ref:`ビルバイン <srw4_unit_bilvine>`\ （比尔拜因）相比，缺乏远程能力，移动力亦处于劣势。强化部件方面，相较机动性提升系，装甲系反而更契合其特性，搭载拥有铁壁而远攻乏力的的嘉拉莉亚・纽姆希亦是良策，不依赖回避也可作为肉盾使用，为我军铁壁防御机体的终极形态。但需注意HP过高以至于在有其他更弱目标时会被敌人无视，不适应团队作战。

第四次S中奥拉斩改为消耗EN。此外因比尔拜因装甲被下调，本机成为奥拉战士中防御力最高的机体。至于优先选择机动性出众的雪拜因还是装甲坚固的兹瓦乌斯，可根据玩家偏好自由抉择。
...
在嘉拉莉亚・纽姆希没有加入的路线加入。相比ゴラオン，虽然少了两名可有可无的无圣战士能力的机师，但是多了两个妖精，在人员配置方面处于压倒性优势。有移动后可使用的远程武器，速通时可以改造。
...
比联邦战舰要坚固得多。有地图炮，可以培训チャム的奇迹，以及其他的圣战士系妖精。具有奇迹+地图炮的毁灭能力。宇宙适应是D，和驾驶员平均下来的地形适应仍然是D，这时候再配备奇迹妖精意义不大。好在B队的宇宙地图就只有两话。
...
由于加入时有5段改造，在奥拉斩改造费昂贵的本作堪称超值。然而第四次S中
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. grid:: 
            ...
            .. grid-item:: \ :ref:`技能 <srw4_unit_specialty>`\ : 分身 (仅PlayStation)、剣装備、オーラバリア。
                :columns: auto
