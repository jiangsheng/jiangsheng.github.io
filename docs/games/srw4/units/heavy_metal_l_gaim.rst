.. meta::
   :description: エルガイム机体：括号内为PS版变动。地形补正(→)为用默认驾驶员的地形适应和机体的移动类型修正之后的数据。ブラッドテンプル, アトールV, エルガイム, エルガイム Mk-II, プローラー, ディザード, オージェ, オージ, アシュラテンプル, カルバリーテンプル, バッシュ, アトール, グルーン, サロンズ, アローン, ガイラム, ヌーベルディザード, グライア 
...
.. grid:: 
    ...
    .. grid-item::
        ...
        | 地形参照
        | :ref:`ダバ・マイロード <srw4_pilots_daba_myroad>`
...
.. grid:: 
    ...
    .. grid-item::
        ...
        | 地形参照
        | :ref:`ファンネリア・アム <srw4_pilots_fanaria_amm>`
...
.. grid:: 
    ...
    .. grid-item::
        ...
        | 地形参照
        | :ref:`ガウ・ハ・レッシィ <srw4_pilots_gaw_ha_leccee>`
...
.. grid:: 
    ...
    .. grid-item::
        ...
        | 地形参照
        | :ref:`ギャブレット・ギャブレー <srw4_pilots_gavlet_gablae>`
...
.. grid:: 
    ...
    .. grid-item::
        ...
        | 地形参照
        | :ref:`クワサン・オリビー <srw4_pilots_quwasan_olibee>`
...
.. grid:: 
    ...
    .. grid-item::
        ...
        | 地形参照
        | :ref:`ハッシャ・モッシャ <srw4_pilots__hasha_moja>`
...
.. grid:: 
    ...
    .. grid-item::
        ...
        | 地形参照
        | :ref:`ネイ・モー・ハン <srw4_pilots_nei_mo_han>`
...
.. grid:: 
    ...
    .. grid-item::
        ...
        | 地形参照
        | :ref:`アマンダラ・カマンダラ <srw4_pilots_amandara_kamandara>`
...
.. grid:: 
    ...
    .. grid-item::
        ...
        | 地形参照
        | :ref:`オルドナ・ポセイダル <srw4_pilots_oldna_poseidal>`
