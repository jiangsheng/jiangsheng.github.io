...
.. _srw4_units_getter_robo_commentEnd:
...
和泰坦3比起来，装甲略薄，即使后期会获得HP回复能力，但是耐久度仍属一般，必须避免深入敌阵，而是在清理小兵之后收拾残局。由于EN消耗较大，建议配备EN回复芯片或者派遣补给机/机师出场。
...
空中形态的盖塔1具有高移动力、高攻击，甚至有射程5-6的移动后可使用的远程武器（虽然只有两发），除了无法继承到后期的ゲッターレザー（盖塔镭射），其他武器都有改满的价值。相比之下其他两个形态因为地形和武器的限制，改造意义不大。

虽然是超级系，但是装甲脆得跟真实系有得一拼……或者你会换到2号机从地下接近敌人？
...
到了中后期地面的敌人有挑战性的本来就不多，我方还有其他的陆战比空战出色的机体，这个形态也就前期有点用，所以不需要改造。
...
无消耗的大雪山おろし可以很容易的消灭陆地和海中的敌人，但是对空能力太差，游戏后期敌人全员空飞的时候不装备ミノフスキークラフト则只有挨打。ミノフスキークラフト正常游戏只能获得一个，因为还有其他强力机体需要，基本没有人会浪费在本机身上。

本作因为海战太少的原因，也不需要改造，用的时候装个装甲就行。在某些特定地图，敌人的机动战士和重战机到我军的路中需要下水，这时候把ゲッター3单独放在水里可以让他们无法使用光线武器，一个个上来送死，是一个速通的小技巧。
...
虽然盖特狮虎的移动力和GP-03有得一拼，但是无消耗的チェーンアタック威力不容小视。非常适合探宝之余顺路对付地面的杂鱼。另外ゲッター2的ドリルストーム的改造不被继承到本机，但是会继承到真ゲッター2的ドリルテンペスト上面去。本机新增的狮虎导弹的改造反而不被真ゲッター2继承。对空仍然乏力。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_1D.png
...
盖特波塞冬的大雪山おろし威力连导弹都不如……另外，对盖特旋风的改造并不会继承到真ゲッター3上。好在陆战还是能用的。至于最擅长的水战……地图很少有水。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_FC.png
...
超级机器人大战原创的机器人。但其设定是经过盖塔射线强化后的旧盖塔机器人。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_FD.png
...
第四次S取消了ゲッターミサイル这个弹药很少的远程武器，而消耗只有5EN的ドリルテンペスト的射程从1~3变成了1~7。从而变成了一个远程消耗机体。虽然现在ドリルテンペスト可以对空了，但是宇宙适应仍然是没有，在宇宙中不如SNES版本。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_FE.png
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. grid:: 
            ...
            .. grid-item:: .. image:: ../pilots/images/srw4_pilot_07.png
                :columns: auto
...
只在速路线临时出战一话，并不会加入。真实系的攻击力和HP，超级系的运动性……武器种类丰富大概是唯一亮点，具有近身、远程和移动后远程的攻击能力。除了那些死要钱的（盖塔队还没幸运），还是当专职探宝队吧。

.. _srw4_unit_texas_mack_commentEnd:

--------
敌军机体
--------
.. _srw4_units_getter_robo_enemy_commentBegin:
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_90.png
...
和ドローメ的区别是一下打不死。岩浆弹是超级机器人大战原创武器，原作并没有。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_8F.png
...
大招攻击力只有790还不能对空的肉靶子。左腕爪子是超级机器人大战原创，原作并没有装备。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_91.png
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_92.png
...
跟機械獣ジェノバM9差不多，但是射程和攻击力更差。这个不是机械恐龙之中的高端机型吗？
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_11E.png
...
大招居然不能对海……一个海战专用机体为什么要装射程1格的火焰喷射器？
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_93.png
...
无人地面补给堡垒。主要武器是火炮和导弹。没有任何近身攻击能力。本应是最强的机械恐龙，但是威胁远远不如\ :ref:`メカザウルス·シグ <srw4_unit_mechasaurus_shigu>`\  (机械恐龙·西格)。

威力不俗的超远程火炮对我方单位还是很为棘手。相对于只有4000的入手金来说，HP太高了。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_94.png
...
具有强大的破坏光线，还能飞，HP和装甲也很高，实力强劲。大概是本作最强机械恐龙。

.. _srw4_unit_mechasaurus_shigu_commentEnd:
