...
如果在宇宙地图的话是一个比较恐怖的力量，超越超级系的耐久度，以及超高的移动力，有两种地图武器，还有游戏中最强的无消耗近战武器，甚至连远程武器都很猛。但是因为游戏路线的原因，只能在\ :doc:`../walkthrough/40a_the_backside_of_the_moon`\ \ 和\ :doc:`../walkthrough/40b_siege_breakthrough`\ 两个互斥的关卡中择一发挥最大战力，在月球表面虽然可以出击，但是一个是驾驶员\ :ref:`コウ・ウラキ <srw4_pilot_kou_uraki>`\ (浦木宏) 的对空适应是C（他不是核心战斗机的驾驶员吗？），另一个是本机对空适应是无，所以攻防非常差。最后在火星的两话不装ミノフスキークラフト就无法出战。

虽说性能太差，但是HP实在高，把巴尼放上去就可以自爆两次，也算是个优点吧……最好配上复活，一点修理费都不付。
...
因为游戏的变身机制，在过关的时候本机会变回未分离的\ :ref:`GP-03デンドロビウム <srw4_unit_gp_03_dendrobium>`\  (GP-03 D)，所以初期加入的是另外一台机体\ :ref:`GP-03ステイメン (初期) <srw4_unit_gp_03_staymen_first>`\ (GP-03 S)，只不过能力和图像完全相同，改造段数也继承，修理费变得很贵。因为地形适应问题，除非有特殊感情，否则最好还是不要改造。
...
不建议改造，因为最后会升级成非常不实用的\ :ref:`GP-03デンドロビウム <srw4_unit_gp_03_dendrobium>`\ (GP-03 D)。仍然是可靠的探宝机。
...
代码RX-78Gp-02A。和前作一样，仅作为盟军出现。加入条件十分复杂，参考\ :ref:`隐藏要素 <srw4_missable_gp_02a>`\ 。

有我方最强大的武器，而且是超远程超大范围的地图炮，无论是\ :ref:`バラン＝シュナイル <srw4_unit_baran_schnile>`\ (巴兰·修奈尔)还是\ :ref:`ネオ·グランゾン <srw4_unit_neo_granzon>`\  (真·古兰森)也可以用激励+魂一击杀，就是入手条件非常苛刻，只有真实系可以入手，超级系无入手意义。入手的时候满改造。虽然驾驶员ガトー远攻击非常强，但是没有魂，所以还是カミーユ来开比较好。クワトロ远攻击虽然更高，但是他离队是本机入手前提，残念。
...
无论如何，由于入手太晚，而入手时最难的关卡已经过去，对游戏难度的影响并不大。
...
移动力超高的机动战士，不过攻击力就不怎么样了，只是凭着机师的能力和改造段数有点威胁。第四次里只在救援运输机的时候和第二十五话強襲！阻止限界点中出战，第四次S里则在グレートマジンガー奪回有再次出场。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. grid:: 
            ...
            .. grid-item:: .. image:: ../pilots/images/srw4_pilot_2E.png
                :columns: auto
...
另外，不知为何，使用等离子领袖会消耗掉大型麦加粒子炮中剩余的所有弹药。明明这两个武器的弹药槽是独立的。
...
攻强守弱的武器库，可能原先考虑过和F完结篇一样加入我军。不过因为地形适应问题，除非一起把地形适应改掉，否则会和\ :ref:`GP-03デンドロビウム <srw4_unit_gp_03_dendrobium>`\  (GP-03 D)一样很难有所表现。
