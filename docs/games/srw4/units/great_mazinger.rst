...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. grid:: 
            ...
            .. grid-item:: .. image:: ../pilots/images/srw4_pilot_5E.png
                :columns: auto
...
虽然地形适应仍然只有一个陆A（第四次S增加空A），大魔神机体属性和マジンガーZ比起来全面提升，但是武器方面导弹数量少了一些，サンダーブレーク油耗也更高，所以持久能力比マジンガーZ差。火力虽超越古连泰沙（グレンダイザー），但是由于后者是双座，可以使用两份精神，还能获得两份经验值，所以在出场选坦克的时候经常是竞争不过丹拜因系列和古连泰沙的。

在丹拜因被分到另一队之后出场机会增加，在经常打到弹尽粮绝的オルドナ＝ポセイダル这一话中和古连泰沙一起作为影响战局的消耗低的超级系机体。用他们作为墙阻挡敌军，让已经行动过的地图武器在下一回合继续发射，或者在主舰中回复EN。

改造方面，实弹武器因为弹药太少而不适合改造，而消耗EN的武器中サンダーブレーク最实用。

第四次S中装甲提升了100点，对空适应提升到A，开战的时候终于不用降落到地面，格斗武器对空的威力也增加了20%。武器方面和魔神Z相同，除了少数之外威力均有上调。

本作增加了大助推器。在本系列作品大助推器采用只有1发残弹的设定。也使得该武器成为冷门，在改造时经常被忽略，直到改造系统变成所有武器同时改造为止。另外本作中大助推器战斗动画和与飞翼横切完全相同，导致不熟悉原作的玩家难以理解为何该武器仅能使用一次。而在《F完结篇》中，则改为凭空取出大推进器发射。另外，大推进器本作为1格射击武器，对理应不能进入的深海地形也能使用。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. grid:: 
            ...
            .. grid-item:: .. image:: ../pilots/images/srw4_pilot_48.png
                :columns: auto
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. grid:: 
            ...
            .. grid-item:: .. image:: ../pilots/images/srw4_pilot_C6.png
                :columns: auto
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. grid:: 
            ...
            .. grid-item:: .. image:: ../pilots/images/srw4_pilot_C7.png
                :columns: auto
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. grid:: 
            ...
            .. grid-item:: .. image:: ../pilots/images/srw4_pilot_C5.png
                :columns: auto
