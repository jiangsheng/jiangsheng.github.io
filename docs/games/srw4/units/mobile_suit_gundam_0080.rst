...
.. _srw4_units_mobile_suit_gundam_0080_commentEnd:

--------
我军机体
--------
.. _srw4_units_mobile_suit_gundam_0080_own_commentBegin:
...
正式名灰色幻影。最初名特洛伊木马号。（舰体编号）为LMSD-76，装备MS的两栖攻击舰。除了名字和外观基本等同于白色基地。

特洛伊木马号是地球联邦军建造的天马级两栖攻击舰的第五艘。代替在上一次大战中已达到极限的白色基地作为朗德·贝尔的第一艘母舰。最初驾驶员是托雷斯，后来是布莱德。由于反复的艰苦战斗而没有适当的补给和维护，最终遭遇了与白色基地相同的命运。

改造一路继承，可以一直用到最后一话（但是你可能想在最后一话派出奥拉系主舰）。有用地图武器练级计划的可以考虑先不改造机体性能，刷完级装载全军然后用Game Over大法再给其他地图武器机体刷一次，这样同一话可以给多个地图武器刷级。可以在机动战士系和重战机系的机师等级全体刷满之后再开始改造。没有自残练级计划的话可以正常改造，但是优先级仍然是地图武器最高，早点刷出两动装载大部队抢占有利地形用，战力不能指望布莱德。

武器改造方面，因为机体性能不佳，改造命中高的火神炮比改造其他武器更为实用。

后期圣战士战舰入手之后因为支持精神更好会优先出击，但是后期分两队的情况下高达系主舰有几话会强制出战，还是有表现的机会的。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_5F.png
...
代号RX-78NT-1。仅在缓路线和克莉丝一起加入。

第四次里面会在\ :doc:`../walkthrough/36_glorious_sunset`\ 之后强制废弃。第四次S无此事件，但是战力还是很弱。在原作中威力强大了加特林机枪，本作中威力仅略高于火神炮。唯一的远程武器是原作未使用的光束步枪但是威力很差。

和高达能力差不多，但是和动画中一样，第四次S中加少了个盾。因为武器问题，对具有光线护盾的重金属和奥拉系敌人基本没有还手之力，使用体验比扎古还要差。第四次S中改善了地形适应，陆A很有用但是海适应是B还是C对默认驾驶员克莉丝来说并无变化。

.. _srw4_unit_nt_1_alex_commentEnd:

--------
敌军机体
--------
.. _srw4_units_mobile_suit_gundam_0080_enemy_commentBegin:
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_76.png
...
代号MS-18E。基本上是一台全副武装的扎古。性能并不出色，但是\ :ref:`ランバ・ラル <srw4_pilot_lamba_ral>`\ (兰巴·拉尔) 开了一台改造了很多段的出来，要特别注意。
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_D8.png
...
.. _srw4_unit_musai_kai_commentEnd:

----------
未登场机体
----------
.. _srw4_units_mobile_suit_gundam_0080_dead_data_commentBegin:
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. image:: ../units/images/portrait/srw4_units_portrait_D4.png
...
.. _srw4_unit_graf_zeppelin_commentEnd:
