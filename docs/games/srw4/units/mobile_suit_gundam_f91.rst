...
.. _srw4_units_mobile_suit_gundam_f91_commentEnd:

--------
我军机体
--------
.. _srw4_units_mobile_suit_gundam_f91_own_commentBegin:


.. _srw4_units_mobile_suit_gundam_f91_own_commentEnd:
...
.. grid:: 
    ...
    .. grid-item:: 
        ...
        .. grid:: 
            ...
            .. grid-item:: \ :ref:`技能 <srw4_unit_specialty>`\ : 分身、盾装備、剣装備。
                :columns: auto
...
代号F-91。具有机动战士系除核弹之外的最高攻击。第四次中大招VSBR需要提升气力才能用，但是驾驶员居然不会気合而是会激励，还好第四次S中降低了气力要求。另外具有分身，也是一个需要提升气力才能用的技能。
...
第四次中EN消耗太大，改满也打不了三炮，还好在第四次S中改善。无论如何，需要改造EN和VSBR。另外，メガマシンキャノン是少见的移动后可以对空的武器，需要速通的话可以改造，本机移动力是少见的10，也是速通要员。

第四次S中不光加强了武器的攻击力，更重要地是加强了地形适应，陆地适应现在是A，威力大大提升。第四次中的陆B有点浪费了几大NT的能力。
...
代号XM-07。需要クワトロ离队才能入手。移动力10、陆宇双A的优秀机体，不逊于\ :ref:`Ζガンダム <srw4_unit_z_gundam>`\ (Z高达)。EN消耗比F91低，可能是燃油效率最高的高端武器，就是入手太晚。

第四次S中F-91的油耗降低，没有加强的本机略为逊色。

.. _srw4_unit_vigna_ghina_commentEnd:

--------
敌军机体
--------
.. _srw4_units_mobile_suit_gundam_f91_enemy_commentBegin:
...
代号XM-05。各项参数本身相当不错，但由于出现得太晚，所以并没有给人留下深刻印象。

它在\ :ref:`第三十话 コロスとドン・サウザー <srw4_walkthrough_30_koros_and_don_zauser>`\ 中才开始出现，那时游戏已经进行到一半了，但它的参数在这个阶段出现显得有些平庸，说实话，它的火力也偏弱。

不知为何，本作移除了它的重机枪，取而代之的是和\ :ref:`ビギナ·ギナ <srw4_unit_vigna_ghina>`\ (比基纳·基纳)一样的光束步枪。
...
代号XMA-01。这台机器本身性能很高，驾驶员卡罗佐可以二次行动，所以很强。

.. _srw4_unit_rafflesia_commentEnd:

--------
盟军机体
--------
.. _srw4_units_mobile_suit_gundam_f91_ally_commentBegin:
...
不知为何，新DC的领袖之一德\ :ref:`エギーユ・デラーズ <srw4_pilot_aiguille_delaz>`\ (艾基尤·迪拉兹) 竟然骑着它。既然这是他唯一一次出场，应该用グワジン（格瓦金）才对。

在\ :ref:`第三十八话 ポセイダルの野心 <srw4_walkthrough_38_poseidal_s_ambition>`\ 开场事件中，它对客队发动了自杀式攻击并自爆。待遇实在太差了……

虽然它的自杀式攻击能造成4万点伤害，但却只跑去击杀一些只有几千生命值的极弱单位，这有点说不过去。这事件设计得非常随意。就算它不能击杀\ :ref:`ライグ＝ゲイオス <srw4_unit_lige_geios>`\ (莱格·盖奥斯)，至少也应该在地图上放两个 \ :ref:`ゼラニオ <srw4_unit_zeranio>`\ (塞拉尼奥)或者\ :ref:`ゲイオス＝グルード <srw4_unit_geios_glud>`\ (盖奥斯·古鲁德)作为靶子吧……

.. _srw4_unit_zamouth_garr_commentEnd:
