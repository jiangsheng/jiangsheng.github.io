...
如果选择有恋人，那么下一话进入 :doc:`06a_stampede`，并且提示你更改恋人姓名， 并且恋人会在宇宙へ（如果选择宇宙路线）或者ティターンズ台頭（如果选择地上路线）作为敌人出现，可以用主角说得。否则 下一话进入 :doc:`06b_rescue_combattler_v`，并且弓さやか会介绍给你一个恋人（名字不能自定义）， 同时加入部队。
