.. meta::
   :description: 第十六话 大将軍ガルーダの悲劇之后，如果ガラリア＝ニャムヒー没有加入，那么进入本话。 很明显ジョン=コーウェン中将的地位有所变化，所以他不得不前往殖民地ロンデニオン寻求本地要塞司令官ブレックス准将的支持。在一封加密信中，他告诉ロンド・ベル其独立程度几乎和以前一样，给你更多的自由空间。不再局限于日本地区的ロンド・ベル队飞

第十七话Ａ オーラマシン展開 (ゴラオン)
======================================

.. _srw4_walkthrough_17a_expansion_of_the_aura_machine_goraon:
...
敌方援军	
--------------------
* \ :ref:`アシュラテンプル <srw4_unit_ashura_temple>`\  (阿修罗神殿)（ワザン＝ルーン）
* アトール（マフ＝マクミトン）
* アトール（バーン＝ガニア＝キラーズ）
* グルーン
* \ :ref:`バッシュ <srw4_unit_bat_shu>`\ (巴修) ×6
* グライア5
...
シルキー加入的时候只有1级，应该在本话练到10级学会幸运，以后可以用来培养主舰等级。另外，尽可能修改ゴラオン的奥拉新星炮和运动性，以及加装运动性芯片。

和\ :doc:`17b_expansion_of_the_aura_machine_gran_garan`\ 类似，敌我双方都是一个オーラバトラー系主舰，一些オーラバトラー系机体，我方主舰在开始时离开。

敌人很危险，尤其是在数量这么多的情况下。两架ボチューン应该尽快和大部队会合。把ゲッター3放在水里的话，敌人自动会一个个上来砍。就算想平均培养，也可以这么吸引走4个敌人。
