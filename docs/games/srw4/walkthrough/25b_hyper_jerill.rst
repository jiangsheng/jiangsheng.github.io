...
.. _srw4_walkthrough_25b_hyper_jerill:
...
* レプラカーン(ハイパー可)（ジェリル＝クチビ）被击破 ジェリル＝クチビ的オーラ力失控，レプラカーンハイパー化成为ハイパーレプラカーン，ジェリル＝クチビ气力成为150
...
下一话宇宙分队中的主角和阿姆罗都会强制换乘，所以可以让他们在本话通关时换乘Z、ZZ之类的强力机体以便超时空传送给地面分队。
