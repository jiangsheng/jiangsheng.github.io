左上角的强化要经过战场，盖塔比较适合去拿。左下的派移动力高的\ :ref:`GP-01Fb <srw4_unit_gp_01fb>`\ 去就可以了。右下角要爬山越岭，能飞的\ :ref:`美塔斯(MA) <srw4_unit_methuss_ma>`\ 比较适合。
...
.. admonition:: 优化组合
    ...
    ガンダム机体太差，建议让アムロ转乘ガンダムｍｋⅡ。另外ボスボロット运动性太差，ボス的命中也是我方最低，经常摸不到人，为了培养ボス起见，应该让他和兜甲児经常互换机体，因为兜甲児有必中，坐ボスボロット也能摸得到敌人。如果不换的话，也可以让ボス转乘\ :ref:`マリンスペイザー <srw4_unit_marine_spacer>`\ ，到グレンダイザー加入之后再与之合体蹭等级，不过这样一开始就少了一点战力。

.. admonition:: 改造
    :class: tip

    :ref:`盖塔小队 <srw4_units_getter_robo>`\ 可从头用到尾，且改造继承，武器也大部继承。是优先改造对象。至于哪些武器不继承到最后，参见\ :ref:`改造 <srw4_remodeling>`\ 。其他序盘机体基本无立刻改造价值。
