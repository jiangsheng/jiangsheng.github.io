...
.. _srw4_walkthrough_41b_haman_s_black_shadow:

\ :doc:`41_scattered_on_axis`\ 之后，如果在\ :doc:`40a_the_backside_of_the_moon`\ 这一话说得了エルピー＝プル和プルツー，并且在战斗结束时选择和\ :ref:`ジュドー・アーシタ <srw4_pilot_judau_ashta>`\ (捷多·亚西塔) 一起去シャングリラ殖民地，那么进入本话。
...
* 在攻击ハマーン之前，\ :ref:`ジュドー・アーシタ <srw4_pilot_judau_ashta>`\ (捷多·亚西塔) 可以说得ハマーン＝カーン，使她信服战斗是毫无意义的，因为她手头已经没有剩余的军队了。ハマーン＝カーン承认ノイエＤＣ几乎被消灭了，但是不会放弃自己的理想。
...
.. flat-table::   
   ...
   * - .. admonition:: \ :ref:`ジュドー・アーシタ <srw4_pilot_judau_ashta>`\ (捷多·亚西塔) 说得ハマーン＝カーン
          :class: attention
...
在帮助独裁者的同时，フル＝フラット被允许从バイオリレーション・システム中获益。这个系统把生命能源转化为物理能源，也曾用于控制\ :ref:`クワサン・オリビー <srw4_pilot_quwasan_olibee>`\ (柯瓦桑·奥利比) 的心智。有了它的帮助可以永葆青春，但是经过漫长的岁月，フル＝フラット渐渐厌倦了永生和永葆青春，因此背叛ポセイダル，同时失去这个特权对她来说是一件好事。

-------------
评论
-------------

解决敌人很简单，但是攻击之前说得ハマーン＝カーン倒是比较麻烦。可以给ZZガンダム装上两个移动力+2的芯片然后切换到飞行状态，可以一回合到达哈曼跟前。
