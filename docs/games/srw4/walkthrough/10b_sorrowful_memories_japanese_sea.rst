...
竜崎一矢对エリカ的全心投入让\ :ref:`和泉ナナ <srw4_pilot_nana_izumi>`\ （和泉奈奈）十分嫉妒。夕月京四郎的尖刻的评论更是火上浇油。为了清静一下，她独自出去执行一次区域调查任务。就在她要返回的时候，她被ＤＣ挡住了。

地图 20x24, 陆地

任务目标:

* 第三回合之前 \ :ref:`和泉ナナ <srw4_pilot_nana_izumi>`\ （和泉奈奈）存活
* 第五回合之前 \ :ref:`和泉ナナ <srw4_pilot_nana_izumi>`\ （和泉奈奈）和カツ＝コバヤシ存活
* 第五回合之后 敌全灭
