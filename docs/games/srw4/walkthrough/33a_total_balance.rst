...
.. _srw4_walkthrough_33a_total_balance:
...
大部分敌人的HP并不多，但是很难击中并且有光线护盾，所以最好派出不依赖于光线武器，或者具有强力光线武器的真实系部队，例如νガンダム、ヤクト・ドーガ（クェス専用）、\ :ref:`リ·ガズィ (MA) <srw4_unit_ri_gazi_ma>`\ (灵格斯BWS着装型)、F-91、Ｓガンダム。
