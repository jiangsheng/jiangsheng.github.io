.. meta::
   :description: 機動戦士ガンダム逆襲のシャア}登场人物 クェス・パラヤ, ケーラ・スゥ, チェーン・アギ, ギュネイ・ガス, ナナイ・ミゲル, レズン・シュナイダー 
.. _srw4_pilots_mobile_suit_gundam_char_s_counterattack:
...
.. _srw4_pilots_mobile_suit_gundam_char_s_counterattack_commentEnd:

--------
我军人物
--------
.. _srw4_pilots_mobile_suit_gundam_char_s_counterattack_own_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        加速 5,根性 1,熱血 26,集中 12,ひらめき 17,かく乱 19
...
.. grid:: 
    ...
    .. grid-item::
        ...
        シールド防御Ｌ2 (シールド防御Ｌ4) 1,Ｌ5 10 (ps),Ｌ6 21 (ps),Ｌ7 29 (ps),Ｌ8 34 (ps)

.. _srw4_pilot_kayra_su_commentBegin:

只在ダバ被ティターンズ带走的路线加入，和ハサウェイ＝ノア冲突。参见\ :ref:`隐藏要素 <srw4_missable>`\ 。

虽然初期能力不错，但是成长率太差。

有加速，对空适应是B，可以用来当初期探宝机师，因为精神偏向战斗，陆战也是A的原因也可以拿来作战。到后期机动战士系可以全员用地图炮练到满级的时候因为成长率太差而且缺乏支援精神而导致没什么上场机会。有干扰这个精神，刷完级可以放在战场上当精神要员。
...
.. grid:: 
    ...
    .. grid-item::
        ...
        熱血 18,集中 7,ひらめき 1,気合 9,必中 3,加速 8
...
.. grid:: 
    ...
    .. grid-item::
        ...
        ニュータイプ 3,シールド防御Ｌ3 1 (ps),Ｌ4 22 (ps),Ｌ5 37 (ps),Ｌ6 41 (ps),切り払いＬ3 1 (ps),Ｌ4 35 (ps),Ｌ5 42 (ps)

.. _srw4_pilot_quess_paraya_commentBegin:
...
虽然有个真实系少见的気合，比较适合F91，但是如果用地图炮刷了级的话，她加入的时候应该不缺激励了。缺乏其他人具有的的魂使得她的输出是个问题。

第四次S中增加了远攻击和回避。增加的シールド防御可以升到6级,切り払い可以升到5级。

.. _srw4_pilot_quess_paraya_commentEnd:

--------
盟军人物
--------
.. _srw4_pilots_mobile_suit_gundam_char_s_counterattack_ally_commentBegin:
...
.. _srw4_pilot_chan_agi_commentEnd:

----------
未登场人物
----------
.. _srw4_pilots_mobile_suit_gundam_char_s_counterattack_dead_data_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        集中 9,気合 4,根性 1,加速 3,熱血 32,ひらめき 12
...
.. grid:: 
    ...
    .. grid-item::
        ...
        強化人間 1,シールド防御Ｌ6 1 (ps),切り払いＬ6 1 (ps)

.. _srw4_pilot_günei_gas_commentBegin:

虽然没有登场，但是设定了能力。第四次S中除了直感和技量之外，其他能力都有所上升。新增的シールド防御出场就有6级，切り払い出场也有6级。
...
.. _srw4_pilot_nanai_miguel_commentBegin:

尽管没有登场，但是设定了能力。第四次S中也增加了命中和回避。
...
.. _srw4_pilot_rezun_schneider_commentBegin:


尽管没有登场，但是设定了能力。第四次S中也全面增加了除直感和技量之外的能力。 

.. _srw4_pilot_rezun_schneider_commentEnd:
