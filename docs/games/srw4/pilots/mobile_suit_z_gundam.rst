...
在开局的速路线\ :ref:`隐藏要素 <srw4_missable>`\ 和尼莫一起加入。选择缓路线则会得到凯拉、克莉丝和巴尼，同时还能获得最强芯片FATIMA。凯拉和巴尼的机体还关乎罗莎米娅的加入条件，而且即使是在第四次S中也会强制废弃ザク改，所以如果不是要看完全剧情或者收集图鉴的话，没有什么必要加入。
...
说服后还需选择是否将其招募为驾驶员。其能力与空战适应性强的フォウ截然不同，拥有高陆战适应性、气合与必杀技能，但缺乏热血精神。
