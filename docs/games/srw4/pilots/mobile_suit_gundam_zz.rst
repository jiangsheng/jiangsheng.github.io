...
.. _srw4_pilots_mobile_suit_gundam_zz_commentEnd:

--------
我军人物
--------
.. _srw4_pilots_mobile_suit_gundam_zz_own_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        根性 1,熱血 13,ひらめき 3,幸運 10,友情 26,補給 46
...
.. grid:: 
    ...
    .. grid-item::
        ...
        ニュータイプ 22,シールド防御Ｌ1 (シールド防御Ｌ3) 1,Ｌ2 (Ｌ4) 21,Ｌ5 26 (ps),Ｌ6 32 (ps)

.. _srw4_pilot_roux_louka_commentBegin:


\ :ref:`隐藏要素 <srw4_missable>`\ 之一。和真实系独占的莎拉冲突，所以建议超级系才收。

能力比较差。还好远攻击成长是最顶级一档。大概只有直感值得一提，38级就可以学得两动。精神配备不错，有幸运和热血，方便地图炮刷级。補給46级就可以练出来，比カツ强得多了。
...
.. grid:: 
    ...
    .. grid-item::
        ...
        熱血 5,集中 1,ひらめき 2,友情 27,根性 1,魂 38
...
.. grid:: 
    ...
    .. grid-item::
        ...
        ニュータイプ 1,切り払いＬ3 1,シールド防御Ｌ4 1,切り払いＬ4 12 (ps),Ｌ5 20 (ps),Ｌ6 33 (ps),Ｌ7 42 (ps),Ｌ8 49 (ps),シールド防御Ｌ5 16 (ps),Ｌ6 28 (ps)

.. _srw4_pilot_judau_ashta_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        根性 4,熱血 7,幸運 19,愛 32,激励 35,てかげん 25
...
.. grid:: 
    ...
    .. grid-item::
        ...
        強化人間 1,切り払いＬ5 1 (ps),Ｌ6 40 (ps)

.. _srw4_pilot_elpeo_ple_commentBegin:

真实系限定。参见\ :ref:`隐藏要素 <srw4_missable>`\ 。

虽说可以用浮游炮，但是远攻击实在有点差，也就比超级系强一点。命中回避和直感倒是不错。

精神方面，出场时回避应该快到溢出限界的时候了，没有集中是个缺点。如果没有用地图武器刷级的话，可以直接拿来做激励人员。因为所在路线敌人少的原因，大概在荒野の死闘这一话才可以用地图炮刷级。
...
.. grid:: 
    ...
    .. grid-item::
        ...
        根性 2,熱血 9,覚醒 18,友情 31,威圧 22,集中 6
...
.. _srw4_pilot_ple_two_commentBegin:
...
.. _srw4_pilot_ple_two_commentEnd:

--------
敌军人物
--------
.. _srw4_pilots_mobile_suit_gundam_zz_enemy_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        愛 10,熱血 8,ド根性 1,てかげん 6,覚醒 21,威圧 20
...
.. grid:: 
    ...
    .. grid-item::
        ...
        シールド防御Ｌ2 (シールド防御Ｌ7) 1,Ｌ8 35 (ps),切り払いＬ5 1 (ps),Ｌ6 33 (ps)

.. _srw4_pilot_mashymre_cello_commentBegin:
...
.. _srw4_pilot_gottn_goh_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        偵察 1,ひらめき 3,集中 8,かく乱 29,隠れ身 21,必中 7
...
.. _srw4_pilot_ni_gilleen_commentBegin:
...
.. _srw4_pilot_lance_gielen_commentBegin:
...
.. _srw4_pilot_rakan_dahkaran_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        根性 3,偵察 1,加速 1,覚醒 23,足かせ 16,かく乱 31
...
.. grid:: 
    ...
    .. grid-item::
        ...
        強化人間 1,シールド防御Ｌ6 1 (ps),切り払いＬ4 1 (ps)

.. _srw4_pilot_ilia_pathom_commentBegin:
...
.. _srw4_pilot_chara_soon_commentBegin:

第四次S中命中和回避上升。

.. _srw4_pilot_chara_soon_commentEnd:

--------
盟军人物
--------
.. _srw4_pilots_mobile_suit_gundam_zz_ally_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        根性 1,熱血 12,集中 8,ひらめき 17,覚醒 29,加速 4
...
.. _srw4_pilot_beecha_oleg_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        根性 1,信頼 7,熱血 13,偵察 4,探索 2,かく乱 14
...
.. grid:: 
    ...
    .. grid-item::
        ...
        ニュータイプ 36,シールド防御Ｌ1 8

.. _srw4_pilot_elle_viano_commentBegin:
...
.. _srw4_pilot_elle_viano_commentEnd:

----------
未登场人物
----------
.. _srw4_pilots_mobile_suit_gundam_zz_dead_data_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        根性 12,愛 20,幸運 19,激励 27,再動 37,脱力 2
...
.. _srw4_pilot_mondo_agake_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        熱血 15,愛 3,集中 7,威圧 29,てかげん 24,かく乱 21
...
.. grid:: 
    ...
    .. grid-item::
        ...
        ニュータイプ 20,切り払いＬ6 1 (ps)

.. _srw4_pilot_glemy_toto_commentBegin:

尽管没有登场，但是第四次S中也增加了切り払い能力，一出场就有6级。

.. _srw4_pilot_glemy_toto_commentEnd:
