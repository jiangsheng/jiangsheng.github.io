.. meta::
   :description: エルガイム}登场人物 リリス・ファウ, ダバ・マイロード, ガウ・ハ・レッシィ, ファンネリア・アム, ギャブレット・ギャブレー, クワサン・オリビー, ミラウー・キャオ, ハッシャ・モッシャ, アマンダラ・カマンダラ, オルドナ・ポセイダル, ネイ・モー・ハン, ギワザ・ロワウ, フル・フラット, リョクレイ・ロン, アントン・ランド, ヘッケラー・マウザー, リィリィ・ハッシー, チャイ・チャー, ワザン・ルーン, マフ・マクトミン, バーン・ガニア・キラーズ, テッド・デビラス 
...
.. _srw4_pilots_heavy_metal_l_gaim_commentEnd:

--------
我军人物
--------
.. _srw4_pilots_heavy_metal_l_gaim_own_commentBegin:
...
.. _srw4_pilot_lilith_fau_commentBegin:

被囚禁于马戏团时被达巴所救，加入同伴行列。曾参战《EX》的朗德·贝尔成员们常将其误认为\ :ref:`チャム・ファウ <srw4_pilot_chum_huau>`\ (查姆·法乌) 。与查姆的见面事件值得一看.但此后便再无交集。

能获得必中·幸运属性，是擅长地图武器的强力战友。本作《ELGAYM》的驾驶员皆具备热血属性，若在中盘后巧妙组合，可实现等级飞跃式提升。但因其始终与某位驾驶员绑定，不同于《DANBAIN》的妖精们，无法通过漏洞将兜甲儿或主角获得的经验值转移给莉莉丝。

在《第4次S》中，同声优配音的查姆拥有语音，唯独莉莉丝未获配音，战斗中亦无台词。

:doc:`謎の訪問者 <../walkthrough/02a_enigmatic_visitors_fast>`\ /\ :doc:`ダハ=マイロド <../walkthrough/05b_daba_my_lord>`\ 登场

必中幸运激励都是很强力的精神。但是重战机系只有这么一个妖精。所以是抢手货，在用地图武器轰自己人还有经验值的版本不怕那些等级太高的机动战士打不到。不知何故，キリマンジャロの嵐这一话中ブレックス准将的机体不断成为她的幸运的目标，即使眼镜厂修正了击落自军可以获得经验的\ :doc:`../mechanics/bug`\ ，击落盟军似乎仍然可以获得资金和经验。
...
.. grid:: 
    ...
    .. grid-item::
        ...
        熱血 4,加速 1,魂 39,集中 18,友情 23,てかげん 8
...
.. grid:: 
    ...
    .. grid-item::
        ...
        シールド防御Ｌ2 1,Ｌ3 4 (ps),Ｌ4 7 (ps),Ｌ5 14 (ps),Ｌ6 19 (ps),Ｌ7 24 (ps),Ｌ8 30 (ps),切り払いＬ1 1 (ps),Ｌ2 12 (ps),Ｌ3 23 (ps)

.. _srw4_pilot_daba_myroad_commentBegin:

塔巴是回避值和技量很高的真实系。精神方面很强劲，有加速、热血和魂，适合迅速解决战斗。就是集中学得慢了一点。地形适应方面，和机动战士系比起来，陆A是个优点。空B造成无法完全发挥后期机体的空中形态的能力，应该尽量少地在空中作战，除了\ :doc:`../walkthrough/31_storm_of_kilimanjaro`\ 这一话之外——这一话虽然是空中，但是地形适应是按陆地算的。有盾防御lv2。二次行动比较早，但是本系都可以用地图炮刷级所以也不算什么很大的优势。
...
.. grid:: 
    ...
    .. grid-item::
        ...
        愛 5,偵察 1,集中 12,熱血 31 (7),鉄壁 43,補給 39
...
.. grid:: 
    ...
    .. grid-item::
        ...
        シールド防御Ｌ1 1,Ｌ2 1 (ps),Ｌ3 7 (ps),Ｌ4 12 (ps),Ｌ5 18 (ps),Ｌ6 23 (ps),Ｌ7 32 (ps),Ｌ8 40 (ps),切り払いＬ1 28 (ps),Ｌ2 36 (ps)

.. _srw4_pilot_fanaria_amm_commentBegin:

相比第三次，本作阿姆作战能力比较差。但是集中出得快，机体又有光线防御和盾防御lv1，生存倒不是什么大问题。有リリス的必中和幸运，用地图炮升级也不是很困难。补给学得比较早，可大幅提升游戏体验。但是因为机体贫弱，建议不要在序盘强行培养，等中期再通过地图武器提升等级。
...
.. grid:: 
    ...
    .. grid-item::
        ...
        熱血 3,集中 7,ひらめき 1,愛 15,激励 19,魂 46
...
.. grid:: 
    ...
    .. grid-item::
        ...
        シールド防御Ｌ2 1,Ｌ3 12 (ps),Ｌ4 17 (ps),Ｌ5 24 (ps),Ｌ6 38 (ps),Ｌ7 40 (ps),Ｌ8 46 (ps),切り払いＬ1 1 (ps),Ｌ2 24 (ps),Ｌ3 36 (ps),Ｌ4 40 (ps)

.. _srw4_pilot_gaw_ha_leccee_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        熱血 1,集中 5,根性 1,ド根性 10,ひらめき 16,魂 42
...
.. grid:: 
    ...
    .. grid-item::
        ...
        シールド防御Ｌ2 (シールド防御Ｌ3) 1,Ｌ4 15 (ps),Ｌ5 19 (ps),Ｌ6 24 (ps),Ｌ7 30 (ps),Ｌ8 38 (ps),切り払いＬ1 12 (ps),Ｌ2 28 (ps),Ｌ3 36 (ps)

.. _srw4_pilot_gavlet_gablae_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        根性 1,信頼 1,ひらめき 1,必中 1,偵察 1,熱血 1
...
.. grid:: 
    ...
    .. grid-item::
        ...
        切り払いＬ1 1 (ps),Ｌ2 32 (ps),Ｌ3 38 (ps)

.. _srw4_pilot_quwasan_olibee_commentBegin:

奥利比是真实系限定的隐藏要素，见到她出场用塔巴说得或交战准没错。 \ :ref:`ギャブレット・ギャブレー <srw4_pilot_gavlet_gablae>`\ (加布雷特·加布雷) 的加入前提。虽可在加入的那关使用，但是过关则离队，所以不要给她经验值。她带来的强力机体巴修也会被直接废弃。

远攻击、回避和直感优秀，属于我军王牌水准。可惜只能用一话。

第四次S中除了直感和技量之外，其他能力都有所上升。新增的切り払い能力可以升到3级。在最终登场的地图"波塞达尔的野心"中，将处于静止状态。


.. _srw4_pilot_quwasan_olibee_commentEnd:

--------
敌军人物
--------
.. _srw4_pilots_heavy_metal_l_gaim_enemy_commentBegin:
...
.. _srw4_pilot__hasha_moja_commentBegin:
...
.. _srw4_pilot_anton_rando_commentBegin:

原作名アントン・ランドー，本作用名大概是个拼写错误。ネイ的副官，除了回避和技量和ネイ差不多，攻击力和命中都差很多。初期出场的时候还能开阿修罗宫殿，后期阿修罗宫殿都成了杂鱼机的时候他反而没有好机器开，连グルーン都能开出来……
...
.. grid:: 
    ...
    .. grid-item::
        ...
        根性 1,ド根性 1,てかげん 1,覚醒 1,激怒 1,加速 1
...
.. _srw4_pilot_heckler_mauser_commentBegin:
...
.. _srw4_pilot_chai_char_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        根性 1,ド根性 1,愛 1,威圧 1,隠れ身 1,気合 1
...
.. _srw4_pilot_nei_mo_han_commentBegin:
...
.. _srw4_pilot_wassan_lune_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        根性 1,ド根性 1,激怒 1,熱血 1,集中 1,ひらめき 1
...
.. grid:: 
    ...
    .. grid-item::
        ...
        切り払いＬ3 1 (ps),Ｌ4 25 (ps)

.. _srw4_pilot_maph_mctomin_commentBegin:
...
.. _srw4_pilot_baan_gania_killas_commentBegin:
...
.. _srw4_pilot_amandara_kamandara_commentBegin:
...
.. _srw4_pilot_rockley_ron_commentBegin:
...
.. grid:: 
    ...
    .. grid-item::
        ...
        根性 1,ド根性 1,激怒 1,威圧 1,てかげん 1,熱血 1
...
.. _srw4_pilot_lily_hasshi_commentBegin:
...
.. _srw4_pilot_giwaza_lowau_commentBegin:
...
.. _srw4_pilot_ted_devilas_commentBegin:
...
.. _srw4_pilot_full_flat_commentBegin:
...
.. _srw4_pilot_oldna_poseidal_commentBegin:


.. _srw4_pilot_oldna_poseidal_commentEnd:

--------
盟军人物
--------
.. _srw4_pilots_heavy_metal_l_gaim_ally_commentBegin:
...
.. _srw4_pilot_mirawoo_kyao_commentBegin:


.. _srw4_pilot_mirawoo_kyao_commentEnd:
