...
.. grid::
    ...
    .. grid-item-card:: レプラカーン(ハイパー可)分离
      :columns: auto
...
.. grid::
    ...
    .. grid-item-card:: ゲシュペンスト（スーパー）变形
      :columns: auto
...
后期地图中禁用变形
"""""""""""""""""""""""""""""
启用这部分代码的话，在敌人数量过多的关卡，例如\ :ref:`第三十六话 栄光の落日 <srw4_walkthrough_36_glorious_sunset>`\ 或者\ :ref: `第三十三话Ｂ <srw4_walkthrough_33b_beyond_the_todd>` 在关卡中或过关后存盘时会死机。

第三十六话 栄光の落日之前可以正常在地图中使用。之后的关卡，可以在整备画面启用，变形后存盘，禁用之后再读盘。
