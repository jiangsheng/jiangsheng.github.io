...
You can equip items to either heal in battle or have various buffs/debuffs. :ref:`Backpacks <front_mission_mechanics_backpack>` can increase item storage and range in addition to power output. Items can be resupplied when standing next to a supply truck or a wanzer with Riff. 
